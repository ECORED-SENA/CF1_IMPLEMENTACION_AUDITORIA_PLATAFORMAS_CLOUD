    ...
    .row.justify-content-center.align-items-center.ma-1
      .col-12.col-md-8.col-lg-10.col-xl-10.mb-4(data-aos="fade")
        LineaTiempoD.color-acento-contenido
            ...
            p(numero="3" titulo="Escalabilidad") En la computación tradicional el proceso de adquirir, configurar y poner en funcionamiento recursos de TI suele ser un proceso demorado y no tan ágil, por el contrario los proveedores de servicios #[i Cloud] pueden realizar aprovisionamiento de recursos a medida de la necesidad de cada empresa en cuestión de minutos o horas según lo requerido, esta característica permite que el cliente pueda crecer o decrecer verticalmente según la demanda, esto permite el ahorro de dinero, las nubes tienen una importante característica denominada elasticidad, donde los recursos se pueden aprovisionar y desaprovisionar de forma dinámica o mediante programación para adaptarse a las cargas de trabajo requeridas.

            p(numero="4" titulo="Flexibilidad") Los proveedores de servicios de #[i Cloud] hoy, tienen la posibilidad de ofrecer servicios flexibles, elásticos y modulares que serán provisionados de acuerdo a la necesidad particular de cada cliente que incluye diferentes plataformas tecnológicas, y diferentes sistemas operativos personalizando las instancias, máquinas virtuales o contenedores de acuerdo a cada necesidad específica.

            p(numero="5" titulo="Uso mejorado") Gracias a la informática en la nube se ha mejorado el acceso a los recursos, pues se comparten recursos físicos entre múltiples clientes a través de tecnologías como la virtualización, y los servidores. #[br] #[br] Ahora se consolidan estos como instancias del sistema operativo que comparten los mismos recursos físicos disponibles, lo que conduce a un ahorro global en energía y refrigeración y reduce la huella de carbono.
            
            p(numero="6" titulo="Implementación rápida y global") Al tener una presencia global, todos los proveedores de servicios de #[i cloud] facilitan el despliegue y presencia rápida y con presencia global, las pequeñas empresas, emprendimientos y #[i startups], pueden llegar más fácilmente a nuevos mercados y competir con otras empresas ya establecidas..
      ...
      .row.justify-content-center.align-items-center.mb-3(data-aos="fade")
        .col-12.col-md-8.col-lg-8.col-xl-8.mb-4
          ImagenInfografica.color-secundario.mb-5
            ...
            .tarjeta.tarjeta-blanca(x="8%" y="45%" numero="")
              .head_tar.mt-0.p-2
              .p-3
                h2.mb-3 Riesgos #[BR]#[span.highlight-1 de seguridad]
                p.text-alinear.mb-0 La informática en la nube permite que los datos e información corporativa de una organización salga del espacio físico de la empresa y sea dispuesta en Internet a través de los servicios de #[i cloud], esto es un riesgo muy alto en cuanto a la seguridad de la información y ciberseguridad, algunas empresas o dominios específicos por sus necesidades particulares y por el tipo de información que soportan, deben de recurrir a nubes privadas o híbridas a fin de garantizar la protección de su información.

            .tarjeta.tarjeta-blanca(x="17%" y="18%" numero="")
              .head_tar.mt-0.p-2
              .p-3
            ...
            .tarjeta.tarjeta-blanca(x="86%" y="20%" numero="")
              .head_tar.mt-0.p-2
              .p-3
            ...
            .tarjeta.tarjeta-blanca(x="93%" y="45%" numero="")
              .head_tar.mt-0.p-2
              .p-3
