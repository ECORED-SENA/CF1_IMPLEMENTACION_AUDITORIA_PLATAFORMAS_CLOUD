...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.fondo-2
      .col-12.col-md-8.col-lg-10.col-xl-10.mb-4 
        ImagenInfografica.color-secundario
          ...
          .tarjeta.color-primario.p-3.tarjeta--azul(x="5%" y="50%" numero="")
          ...
          .tarjeta.color-primario.p-3.tarjeta-violeta(x="29%" y="50%" numero="")
          ...
          .tarjeta.color-primario.p-3.tarjeta-violeta(x="75%" y="50%" numero="")
    ...
    .row.justify-content-center.align-items-center
      ...
      p <b>El modelo de referencia para las redes de comunicaciones es #[span.highlight el modelo OSI -Interconexión de Sistemas Abiertos,] el cual se explica a continuación, veamos:</b>
      ...
      .row.justify-content-center.align-items-center.fondo-2.mb-3
        .col-12.col-md-8.col-lg-8.col-xl-8.mb-4 
          ImagenInfografica.color-secundario.mb-5
            ...
            .tarjeta.p-3.tarjeta-blanca(x="50%" y="12%" numero="")
              ...
              p.text-alinear Los protocolos de capa física describen los medios mecánicos, eléctricos, funcionales y de procedimiento para activar, mantener y desactivar conexiones físicas para la transmisión de bits hacia un dispositivo de red y desde el.

            .tarjeta.p-3.tarjeta-blanca(x="50%" y="25%" numero="")
              ...
              h3.mb-5 Acceso a los medios
                .pRelative_1
                  .backtoTop_1
                    figure
                      img(src='@/assets/curso/images/tema1/line.svg' alt='' , style="width:7px; display:block; margin:1rem 6.4rem;")
              p.text-alinear Los productos de capa de enlace de datos describen los métodos para intercambiar tramas de datos entre dispositivos en un medio común.

              
            .tarjeta.p-3.tarjeta-blanca(x="50%" y="37%" numero="")
              ...
              h3.mb-5 Direccionamiento y mejor ruta
                .pRelative_1
                  .backtoTop_1
                    figure
                      img(src='@/assets/curso/images/tema1/line.svg' alt='' , style="width:7px; display:block; margin:1rem 6.4rem;")
              p.text-alinear La capa de red, proporciona servicios para intercambiar los datos individuales en la red entre dispositivos finales identificados.
              

            .tarjeta.p-3.tarjeta-blanca(x="50%" y="48%" numero="")
              ...
              h3.mb-5  Conexiones de extremo a extremo
                .pRelative_1
                  .backtoTop_1
                    figure
                      img(src='@/assets/curso/images/tema1/line.svg' alt='' , style="width:7px; display:block; margin:1rem 6.4rem;")
              p.text-alinear La capa de transporte, define los servicios para segmentar, transferir y rearmar los datos para las comunicaciones individuales entre dispositivos finales.

            .tarjeta.p-3.tarjeta-blanca(x="50%" y="60%" numero="")
              h3.bg-color-2.text-white Sesión - Comunicación entre dispositivos de red
              h3.mb-5 Comunicación entre hosts
                .pRelative_1
                  .backtoTop_1
                    figure
                      img(src='@/assets/curso/images/tema1/line.svg' alt='' , style="width:7px; display:block; margin:1rem 6.4rem;")
              p.text-alinear La capa de sesión, proporciona servicios a la capa de presentación para organizar su diálogo y administrar el intercambio de datos.

              
            .tarjeta.p-3.tarjeta-blanca(x="50%" y="75%" numero="")
              ...
              h3.mb-5 Representación de datos
                .pRelative_1
                  .backtoTop_1
                    figure
                      img(src='@/assets/curso/images/tema1/line.svg' alt='' , style="width:7px; display:block; margin:1rem 6.4rem;")
              p.text-alinear La capa de red, proporciona una representación común de los datos transferidos entre los servicios de la capa de aplicación.

            .tarjeta.p-3.tarjeta-blanca(x="50%" y="91%" numero="")
              ...
              h3.mb-5  Procesos de red a aplicaciones
                .pRelative_1
                  .backtoTop_1
                    figure
                      img(src='@/assets/curso/images/tema1/line.svg' alt='' , style="width:7px; display:block; margin:1rem 6.4rem;")
              p.text-alinear La capa de red, proporciona los medios para la conectividad de extremo a extremo entre individuos de la red humana mediante redes de datos.
      ...
      .row.justify-content-center.align-items-center.fondo-2
          .col-12.col-md-8.col-lg-6.col-xl-5.mb-4
            img.mx-3(src="@/assets/curso/images/tema1/img_9.svg" alt="AvatarTop", style="width:370px; display:block; margin:-6rem 3rem;").mb-4
          .col-12.col-md-4.col-lg-6.col-xl-7.my-3
      ...
      .col-lg-12.mx-auto.mb-5
        .bloque-texto-a.color-custom-1.p-4.p-md-5
          .row.m-0.align-items-center.justify-content-between
            .col-lg-9
              .bloque-texto-a__texto.p-4
      ...
      .row.align-items-center.fondo-18.mb-5
        .col-12.col-md-8.col-lg-4.col-xl-4
          img.my-0(src="@/assets/curso/images/tema1/img_pc.svg" alt="AvatarTop", style="width:370px; display:block; margin:-6rem -5rem;")
      ...
      .row.justify-content-center.align-items-center.mb-5.fondo-3
        .col-12.col-md-8.col-lg-6.col-xl-5.mb-4
          img.mx-3(src="@/assets/curso/images/tema1/img_26.svg" alt="AvatarTop", style="width:370px; display:block; margin:-6rem 3rem;").mb-3
        .col-12.col-md-4.col-lg-6.col-xl-7.my-3
